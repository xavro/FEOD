...
/**
 * AmorcageImageTraitement
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class AmorcageImageTraitement
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="amorcage_imageTraitement", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Amorcage", inversedBy="imagesTraitement")
     */
    private $amorcage;

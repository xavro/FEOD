...
class ImageVecteur
{
     ...
     *
     * @Vich\UploadableField(mapping="munition_imageVecteur", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Munition", inversedBy="imagesVecteur")

...
/**
 * AmorcageImageConditionnement
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class AmorcageImageConditionnement
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="amorcage_imageConditionnement", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Amorcage", inversedBy="imagesConditionnement")
     */
    private $amorcage;

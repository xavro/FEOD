...
class ImageDimensions
{
     ...
     *
     * @Vich\UploadableField(mapping="munition_imageDimensions", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Munition", inversedBy="imagesDimensions")

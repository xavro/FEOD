...
class ImageMarquages
{
     ...
     *
     * @Vich\UploadableField(mapping="munition_imageMarquages", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Munition", inversedBy="imagesMarquages")

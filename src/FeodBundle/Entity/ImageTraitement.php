...
class ImageTraitement
{
     ...
     *
     * @Vich\UploadableField(mapping="munition_imageTraitement", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Munition", inversedBy="imagesTraitement")

...
/**
 * AmorcageImageFonctionnement
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class AmorcageImageFonctionnement
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="amorcage_imageFonctionnement", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Amorcage", inversedBy="imagesFonctionnement")
     */
    private $amorcage;

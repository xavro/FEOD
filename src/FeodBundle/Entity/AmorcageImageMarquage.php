...
/**
 * AmorcageImageMarquage
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class AmorcageImageMarquage
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="amorcage_imageMarquage", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Amorcage", inversedBy="imagesMarquages")
     */
    private $amorcage;

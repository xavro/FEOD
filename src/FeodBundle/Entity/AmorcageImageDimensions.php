...
/**
 * AmorcageImageDimensions
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class AmorcageImageDimensions
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="amorcage_imageDimensions", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Amorcage", inversedBy="imagesDimensions")
     */
    private $amorcage;

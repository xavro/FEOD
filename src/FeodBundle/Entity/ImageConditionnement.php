...
/**
 * ImageConditionnement
 *
 * @ORM\Table()
 * @ORM\Entity
 * @Vich\Uploadable
 */
class ImageConditionnement
{
    /**
     * @var integer
     *
     ...
     *
     * @Vich\UploadableField(mapping="munition_imageConditionnement", fileNameProperty="name")
     * @Assert\File(
     *      maxSize="6000000",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FeodBundle\Entity\Munition", inversedBy="imagesConditionnement")

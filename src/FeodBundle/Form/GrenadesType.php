...
class GrenadesType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
		...
		->add("DiametreGrenade","number",array("label"=>"Calibre ou Ø (mm)","required"=>false))
		...
		->add("RetardDe","number",array("label"=>"Retard : &nbsp &nbsp de (s)","required"=>false))
		->add("RetardA","number",array("label"=>" à (s)","required"=>false))
		...
		->add("NatureChargementPrin","entity",array("label"=>"Nature","attr" => array("class" => "chosen-select"),"required"=>false,"empty_value" => "Choisissez une option","class"=>"FeodBundle:NatureChargeMili"))
		...
		->add("DiametreChargePropu","number",array("label"=>"Calibre (mm)","required"=>false))

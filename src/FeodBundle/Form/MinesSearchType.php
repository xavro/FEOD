...
class MinesSearchType extends AbstractType
{
    /**
...
//base
        $builder->add('nomine','text',array('attr' => array('class' => 'col-sm-5'),'label'=>'Nom','required'=>false))
        ...
        ->add('rouge','checkbox',array('required'=>false,'attr' => array('class' => 'rougebox')))
                ...
                ->add('nomAllumeurMine','text',
                        array('label'=>'Nom de l\'allumeur règlementaire','required'=>false))
                ->add('positionAllumeurOrigine','entity',
                    array('attr' => array('label'=>'Position allumeur origine','class' => 'chosen-select'),'multiple'=>false,'required'=>false,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:PositionAllumeurOrigine'))

                ->add('declenchement','entity',
                    array('label'=>'Déclenchement','attr' => array('class' => 'chosen-select'),'multiple'=>false,'required'=>false,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:Declenchement'))
                ->add('nombreAlveolePiegeage','integer',
                    array(array('min'=>0,'max'=>1000000000000000000),'label'=>'Nombre d\'alvéole(s) de piégeage','required'=>false))
        ...
        //chargement
            ...
            ->add('natureChargeDepotage','entity',
                    array('label'=>'Nature','attr' => array('class' => 'chosen-select'),'required'=>false,'multiple'=>true,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:NatureChargeDispersion'))
...
//amorcage
            ...
            ->add('nombrePuitAmorcage','integer',
                    array('attr'=>array('min'=>0,'max'=>1000000000000000000),'label'=>'Nombre','required'=>false))
            ->add('alveolePiegeage','checkbox',
                    array('label'=>'Alvéole de piégeage','required'=>false))
            ->add('nombreAlveolePiegeage','integer',
                    array('attr'=>array('min'=>0,'max'=>100000000),'label'=>'Nombre','required'=>false))
            ->add('positionAlveolePiegeage','entity',
                    array('label'=>'Position allumeur(s) de piégeage','attr' => array('class' => 'chosen-select'),'multiple'=>true,'required'=>false,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:PositionMarquage'))

...
class RoquettesSearchType extends AbstractType
{
    /**
...
// Généralités		
		...
		->add("PoidsRoq","number",array("label"=>"Poids de la roquette(kg)","required"=>false))
...
// 	Chargement
		...
		->add("NatureChargePropu","entity",array("label"=>"Nature","attr" => array("class" => "chosen-select"),"required"=>false,"empty_value" => "Choisissez une option","class"=>"FeodBundle:NatureCP"))

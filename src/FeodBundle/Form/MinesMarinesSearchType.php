...
class MinesMarinesSearchType extends AbstractType
{
    /**
...
//aspectDimensions
		->add('FormeGenerale','entity',
				array('label'=>'Forme de la mine','attr' => array('class' => 'chosen-select'),'required'=>false,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:MMForme'))

...
class AmorcageType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('UnitePoidsFusee','entity',array('label'=>'Unité','attr' => array('class' => 'chosen-select'),'required'=>false,'class'=>'FeodBundle:UniteMasse'))
        ...
        //chargement
            ...
            ->add('nbrRelais','integer',
                    array('attr'=>array('min'=>0,'max'=>4),'label'=>'Nombre','required'=>false))
            ->add('poidsRelais','number',array('label'=>'Poids (g)','required'=>false))
            ->add('poidsDeto','number',array('label'=>'Poids (g)','required'=>false))
            ->add('poidsAmorce','number',array('label'=>'Poids (g)','required'=>false))
        ...
        //aspectDimensions
            ...
            ->add('hauteurVisible','number',array('label'=>'Hauteur Visible (mm)','required'=>false))
        ...
        //fonctionnement
            ...
            ->add('AmorcageDelais','entity',array('attr' => array('class' => 'chosen-select'),'label'=>'Délais',
                'required'=>false,'multiple'=>true,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:AmorcageDelais'))
            ->add('AmorcageEnergie','entity',array('attr' => array('class' => 'chosen-select'),'label'=>'Energie utilisée',
                'required'=>false,'multiple'=>true,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:AmorcageEnergie'))
            ->add('AmorcageDeclenchement','entity',array('attr' => array('class' => 'chosen-select'),'label'=>'Déclenchement',
                'required'=>false,'multiple'=>true,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:AmorcageDeclenchement'))
            ...
            ->add('AmorcageModeAction','entity',
                    array('label'=>'Mode d\'Action','attr' => array('class' => 'chosen-select'),'required'=>false,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:AmorcageModeAction'))
            
		//Munitions associées
			 ->add('MunitionsAssociees','textarea',array('label'=>'Munitions Associées','required'=>false  , 'attr' => array('rows' => '3')))
        ...
        //gestion
            ...
            ->add('images', 'collection',
                    array('type' => new AmorcageImageType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesMarquages', 'collection',
                    array('type' => new AmorcageImageMarquageType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesFonctionnement', 'collection',
                    array('type' => new AmorcageImageFonctionnementType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesConditionnement', 'collection',
                    array('type' => new AmorcageImageConditionnementType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesVecteur', 'collection',
                    array('type' => new AmorcageImageVecteurType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesTraitement', 'collection',
                    array('type' => new AmorcageImageTraitementType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesChargement', 'collection',
                    array('type' => new AmorcageImageChargementType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
            ...
            ->add('imagesDimensions', 'collection',
                    array('type' => new AmorcageImageDimensionsType(),
                            'allow_add' => true,
                            'allow_delete' => false,
                            'by_reference' => false,
                            ))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'FeodBundle\Entity\Amorcage'
        ));
    }

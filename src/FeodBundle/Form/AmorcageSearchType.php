...
class AmorcageSearchType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        //fonctionnement
			...
			//->add('ModeDeFonctionnement','entity',array('attr' => array('class' => 'chosen-select col-sm-4'),'label'=>'Mode de Fonctionnement',
            //    'required'=>false,'multiple'=>true,'empty_value' => 'Choisissez une option','class'=>'FeodBundle:FuseeModeFonctionnement'))

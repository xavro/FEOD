 ...
 */
class ExplosifRepository extends EntityRepository
{

    public function countAll(){
        $count = $this->getEntityManager()
            ->createQuery('SELECT COUNT(a.id) FROM FeodBundle:Explosif a')
    ...
    */
    ...
    public function findLast($i)
    {
        $result = $this->getEntityManager()
            ->createQuery('SELECT a FROM FeodBundle:Explosif a
    ...
    public function CountByExplosifId($explosifId){
        $count = $this->getEntityManager()
            ->createQuery('SELECT COUNT(a.id) FROM FeodBundle:Explosif a
            WHERE a.explosifId = :explosifId')
            ->setParameter('explosifId', $explosifId)
            ->getSingleScalarResult();
        return $count;
    }

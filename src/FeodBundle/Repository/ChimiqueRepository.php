 ...
 */
class ChimiqueRepository extends EntityRepository
{

    public function countAll(){
        $count = $this->getEntityManager()
            ->createQuery('SELECT COUNT(a.id) FROM FeodBundle:Chimique a')
    ...
    */
    ...
    public function findLast($i)
    {
        $result = $this->getEntityManager()
            ->createQuery('SELECT a FROM FeodBundle:Chimique a
    ...
    public function CountByChimiqueId($explosifId){
        $count = $this->getEntityManager()
            ->createQuery('SELECT COUNT(a.id) FROM FeodBundle:Chimique a
